...
<head>
    ...
    <title>Welcome to LavaLust - Jastine</title>
...
<div class="hero wrap">
    ...
    <p class="hero-sub">
        A lightweight, expressive PHP MVC framework built for developers who want structure without the bloat - — Deployed by Jastine Opredo
    </p>
